...
abstract class AbstractCommandTest {
    ...
    protected EplTelegramBot eplTelegramBot = Mockito.mock(EplTelegramBot.class);
    protected TelegramUserService telegramUserService = Mockito.mock(TelegramUserService.class);
    protected SendBotMessageService sendBotMessageService = new SendBotMessageServiceImpl(eplTelegramBot);
